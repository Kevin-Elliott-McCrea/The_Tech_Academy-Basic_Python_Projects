...
def load_gui(self):
    ...
    self.lbl_fname = tk.Label(self.master,text='Last Name:')
    self.lbl_fname.grid(row=2,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_fname = tk.Label(self.master,text='Phone Number:')
    self.lbl_fname.grid(row=4,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_fname = tk.Label(self.master,text='Email Address:')
    self.lbl_fname.grid(row=6,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_fname = tk.Label(self.master,text='User:')
    self.lbl_fname.grid(row=0,column=2,padx=(0,0),pady=(10,0),sticky=N+W)
